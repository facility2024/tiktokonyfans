...
import { Heart, MessageCircle, User, Play, Pause, Home, Bell, Menu, X, ShieldAlert, Volume2, VolumeX, Crown, Mail } from 'lucide-react';
...
const TikTokApp = () => {
  ...
  // Sistema de limpeza automática de cache para máxima performance
  useEffect(() => {
    const cleanupInterval = setInterval(() => {
      if (videoRefs.current.length > 0) {
        videoRefs.current.forEach((video, index) => {
          if (video && Math.abs(index - currentVideoIndex) > 3) {
            // Limpa vídeos distantes da memória
            video.preload = 'none';
            video.src = '';
            video.load();
  ...
  // Todos os vídeos com avatares reais dos criadores
  const videos = [
    {
      id: 101,
      ...
      description: "Andreininha arrasando! 🔥 #viral #brasil #trending",
    ...
    },
    {
      ...
      description: "Babi mandando muito bem! 💥 #viral #trending",
    ...
    },
    {
      ...
      description: "Fabiola arrasando sempre! 🌟 #content #amazing",
...

    {
      ...
      description: "Mais flagrantes incríveis! 🔥 #trending #viral",
    ...
    },
    {
      ...
      description: "Gabriela simplesmente incrível! 💖 #amazing #top",
    ...
    },
    {
      ...
      description: "Isa Grey mandando ver! 🌟 #content #viral",
    ...
    },
    {
      ...
      description: "Jaqueline arrasando! 🔥 #viral #brasil",
    ...
    },
    {
      ...
      username: "Jelma",
      displayName: "Jelma",
      description: "Jelma com conteúdo incrível! ✨ #amazing #content",
    ...
    },
    {
      ...
      description: "Live vazada incrível! 💥 #live #vazado #viral",
    ...
    },
    {
      ...
      username: "LiveVazada",
      displayName: "Live Vazada",
      description: "Mais live vazada! 🌟 #exclusive #live",
    ...
    },
    {
      ...
      username: "LiveVazada",
      displayName: "Live Vazada",
      description: "Live vazada exclusiva! 🔥 #trending #live",
      avatar: "assets/live_avatar.png?prompt=Live%20streaming%20setup%2C%20digital%20background%2C%20tech%20vibes",
      likes: 3987,
      comments: 298
    },
    {
      ...
      description: "Ly Collins arrasando! 💫 #viral #trending",
    ...
    },
    {
      ...
      description: "Marian mandando muito bem! 🔥 #amazing #content",
    ...
    },
    {
      ...
      description: "Maria Safadinha com tudo! 🌟 #viral #brasil",
    ...
    },
    {
      ...
      description: "Priscila simplesmente incrível! 💖 #amazing #top",
    ...
    },
    {
      ...
      description: "Saracine arrasando! 🔥 #viral #trending",
    ...
    },
    {
      ...
      username: "Suzi",
      displayName: "Suzi",
      description: "Suzi mandando ver! 🌟 #viral #brasil",
    ...
    },
    {
      ...
      description: "Tal da Loira arrasando! 💥 #viral #trending",
    ...
    },
    {
      ...
      username: "ThaissaFit",
      displayName: "Thaissa Fit",
      description: "Thaissa Fit parte 2! 🔥 #workout #amazing",
    ...
    },
    {
      ...
      description: "Conteúdo exclusivo de hoje! 💣 #exclusivo #viral",
    ...
    },
    {
      ...
      description: "White Fairy mágica! ✨ #fairy #amazing",
    ...
    },
    {
      ...
      username: "WhiteFairy",
      displayName: "White Fairy",
      description: "White Fairy parte 2! 🌟 #magical #content",
    ...
    },
    {
      ...
      description: "Conteúdo exclusivo da Agnes 🔥 #viral #brasil #trending",
    ...
    },
    {
      ...
      description: "Bia arrasando como sempre 🌟 #criativo #brasil #viral",
    ...
    },
    {
      ...
      description: "Ester Muniz com conteúdo incrível 💫 #amazing #content",
    ...
    },
    {
      ...
      displayName: "Gabriella Euzébio",
      description: "Gabriella mandando ver! 🔥 #viral #brasil #top",
    ...
    },
    {
      ...
      description: "Hellen Beatriz arrasando 💥 #trending #amazing",
    ...
    },
    {
      ...
      description: "Isadora Santos com conteúdo top 🌟 #viral #content",
    ...
    },
    {
      ...
      description: "Lavinia Loren simplesmente incrível 💖 #amazing #top",
    ...
    },
    {
      ...
      description: "Mari Ribeiro arrasando! 🔥 #viral #trending",
    ...
    },
    {
      ...
      username: "MariRibeiro",
      displayName: "Mari Ribeiro",
      description: "Mari Ribeiro parte 2! 💫 #content #amazing",
      avatar: "assets/mari_avatar.png?prompt=Beautiful%20Brazilian%20woman%20with%20dark%20hair%2C%20radiant%20smile%2C%20natural%20glow",
      likes: 1945,
      comments: 156
    },
    {
      ...
      description: "Melissa Galmon com tudo! 🌟 #viral #brasil",
    ...
    },
    {
      ...
      description: "Conteúdo que vai dar o que falar! 💥 #trending #viral",
    ...
    },
    {
      ...
      username: "Thaina",
      displayName: "Thainá",
      description: "Thainá mandando muito bem! ✨ #amazing #content",
    ...
    },
    {
      ...
      description: "Tuani Basotti arrasando! 🔥 #viral #top",
    ...
    },
    {
      ...
      displayName: "Conteúdo Vazado",
      description: "Conteúdo exclusivo vazado! 💣 #exclusivo #viral",
    ...
    },
    {
      ...
      username: "ConteudoVasado",
      displayName: "Conteúdo Vazado",
      description: "Mais conteúdo exclusivo! 🔥 #vazado #trending",
    ...
    },
    {
      ...
      username: "ConteudoVasado",
      displayName: "Conteúdo Vazado",
      description: "Conteúdo que todo mundo quer ver! 💫 #exclusivo",
      avatar: "assets/vazado_avatar.png?prompt=Mysterious%20silhouette%20with%20question%20mark%2C%20dark%20background%2C%20exclusive%20content%20vibe",
      likes: 5234,
      comments: 456
    },
    {
      ...
      username: "ConteudoVasado",
      displayName: "Conteúdo Vazado",
      description: "Mais um vazado incrível! 🌟 #viral #exclusivo",
      avatar: "assets/vazado_avatar.png?prompt=Mysterious%20silhouette%20with%20question%20mark%2C%20dark%20background%2C%20exclusive%20content%20vibe",
      likes: 2967,
      comments: 234
    },
    {
      ...
      username: "ConteudoVasado",
      displayName: "Conteúdo Vazado",
      description: "Conteúdo top vazado! 🔥 #trending #amazing",
      avatar: "assets/vazado_avatar.png?prompt=Mysterious%20silhouette%20with%20question%20mark%2C%20dark%20background%2C%20exclusive%20content%20vibe",
      likes: 3456,
      comments: 312
    },
    {
      ...
      description: "Amanda Albuquerque arrasando! 💥 #viral #brasil",
    ...
    },
    {
      ...
      description: "Dyh Costa com conteúdo incrível! ✨ #amazing #content",
    ...
    },
    {
      ...
      description: "Kerolay Chaves mandando ver! 🔥 #viral #trending",
    ...
    },
    {
      ...
      description: "Marina Lage simplesmente incrível! 💖 #amazing #top",
    ...
    },
    {
      ...
      username: "MarinaLage",
      displayName: "Marina Lage",
      description: "Marina Lage parte 2! 🌟 #content #viral",
  ...
  // Tela de abertura com logo pulsante
  useEffect(() => {
  ...
  // Inicialização dos dados dos vídeos
  useEffect(() => {
    if (isLoggedIn) {
      const initialLikes = {};
      ...
      videos.forEach(video => {
        ...
        initialComments[video.id] = [
          { id: 1, user: "Usuario1", text: "Incrível! 🔥", likes: 12 },
          { id: 2, user: "Usuario2", text: "Amei o conteúdo!", likes: 8 },
          { id: 3, user: "Usuario3", text: "Top demais! 💫", likes: 15 }
        ];
      });
  ...
  // Controle dos vídeos ultra-otimizado para máxima performance
  useEffect(() => {
    if (isLoggedIn) {
      ...
      if (currentVideo) {
        ...
        // Reprodução otimizada com múltiplas tentativas
        if (isPlaying) {
          const attemptPlay = async () => {
            try {
              await currentVideo.play();
            } catch (error) {
              // Tentativa com delay para dispositivos móveis
              setTimeout(async () => {
                try {
                  await currentVideo.play();
                } catch (retryError) {
      ...
      // Otimização avançada de memória e preload
      videoRefs.current.forEach((video, index) => {
        if (video) {
          if (index !== currentVideoIndex) {
            video.pause();
            video.currentTime = 0; // Reset para economizar memória
          }
          
          // Preload inteligente baseado na proximidade
  ...
  const handleLogin = (e) => {
    ...
    if (!email.includes('@gmail.com')) {
      setLoginError('Por favor, use um email do Gmail válido');
      return;
    }
    
    // Simulação de verificação (aqui você integraria com sua API)
    // Email padrão autorizado
    if (email.toLowerCase() === 'teste@gmail.com') {
      setIsLoggedIn(true);
      setShowLogin(false);
    } else {
      setLoginError('Email não autorizado. Use: teste@gmail.com');
    }
  };
  ...
  const handleScroll = (e) => {
    ...
    if (newIndex !== currentVideoIndex && newIndex >= 0 && newIndex < videos.length) {
      ...
      // Otimização de scroll ultra-rápida
      requestAnimationFrame(() => {
        videoRefs.current.forEach((video, index) => {
          if (video) {
            ...
            if (distance === 0) {
              // Vídeo atual: carregamento completo
              video.preload = 'auto';
              if (video.readyState < 2) {
                video.load();
              }
            } else if (distance <= 1) {
              // Vídeos próximos: metadata apenas
              video.preload = 'metadata';
            } else {
              // Vídeos distantes: limpar da memória
              video.preload = 'none';
              if (video.readyState > 0) {
                video.src = video.src; // Force reload para limpar cache
              }
            }
          }
        });
  ...
  if (showLogin && !isLoggedIn) {
    return (
      <div className="w-full h-full bg-black bg-opacity-95 flex items-center justify-center" style={{ minHeight: '600px' }}>
        <div className="bg-gray-900 rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Para logar no app você precisa estar logado com seu Gmail de acesso
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  <h3 className="text-white font-semibold">Google Chrome</h3>
                  <p className="text-gray-400 text-sm">Autenticação segura</p>
                </div>
              </div>
            ...
            {loginError && (
              <div className="bg-red-900 bg-opacity-50 border border-red-500 text-red-400 p-3 rounded-lg text-sm">
                {loginError}
              </div>
            )}
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-500 text-xs">
              ⚠️ Apenas usuários autorizados podem acessar este conteúdo
            </p>
          </div>
        </div>
      </div>
  ...
  // App principal (só mostra se estiver logado)
  if (!isLoggedIn) {
    return null;
  }

  return (
    <div className="w-full h-full bg-black relative overflow-hidden" style={{ minHeight: '600px' }}>
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 z-20 flex justify-between items-center p-4">
        ...
        <div className="flex items-center space-x-8">
          <span className="text-white text-lg font-medium opacity-60">Following</span>
      ...
      {showSidebar && (
        <div className="absolute inset-0 z-50 flex">
          <div className="w-80 bg-gray-900 h-full overflow-y-auto">
            ...
            <div className="p-4">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full flex items-center space-x-3 p-3 text-white hover:bg-gray-800 rounded-lg">
      ...
      {showComments && (
        <div className="absolute inset-0 z-50 flex">
          ...
          <div className="w-96 bg-gray-900 h-full overflow-y-auto">
            <div className="p-4 border-b border-gray-700">
              <div className="flex justify-between items-center">
                <h2 className="text-white text-xl font-bold">Comentários</h2>
                <button 
                  onClick={() => setShowComments(false)}
                  className="text-white p-2 hover:bg-gray-800 rounded-full"
                >
      ...
      {showGallery && (
        <div className="absolute inset-0 z-50 bg-black flex items-center justify-center">
          ...
          {/* Image Counter */}
          <div className="absolute top-4 left-4 z-60 text-white bg-black bg-opacity-50 px-3 py-1 rounded-full">
          ...
          <div className="bg-gray-900 rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                />
                <div>
                  <h3 className="text-white font-semibold">{currentVideo?.displayName}</h3>
                  <p className="text-gray-400 text-sm">@{currentVideo?.username}</p>
                </div>
              </div>
              ...
              <div className="bg-gray-800 rounded-lg p-4 mb-4">
                ...
                <ul className="text-gray-300 text-sm space-y-1">
                  <li>• Vídeos exclusivos sem censura</li>
                  <li>• Fotos premium em alta qualidade</li>
                  <li>• Conteúdo personalizado</li>
                  <li>• Acesso antecipado a novos vídeos</li>
                  <li>• Chat direto com as criadoras</li>
                </ul>
              </div>
            ...
            <div className="space-y-3">
              <button className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-black py-3 rounded-lg font-semibold hover:from-yellow-600 hover:to-yellow-700 transition-all flex items-center justify-center">
                <Crown className="w-5 h-5 mr-2" />
                Compre Agora - Acesso VIP
              </button>
              
              <button className="w-full bg-gray-700 text-white py-3 rounded-lg font-semibold hover:bg-gray-600 transition-all">
                🔒 Meus Conteúdos VIP
              </button>
            </div>
            
            <p className="text-gray-500 text-xs text-center mt-4">
              ⚠️ Conteúdo apenas para maiores de 18 anos
            </p>
          </div>
        </div>
      )}
      ...
      >
        {videos.map((video, index) => (
          <div key={video.id} className="relative h-full w-full snap-start flex items-center justify-center" style={{ minHeight: '600px' }}>
            <video
              ...
              onError={() => {
                // Correção otimizada para reprodução de vídeos com tratamento especial para Flaga na rua02.mp4
                const videoEl = videoRefs.current[index];
                if (videoEl) {
                  // Tratamento especializado para o vídeo específico com problemas
                  if (video.videoUrl.includes('Flaga%20na%20rua02.mp4')) {
                    console.log('Aplicando correção específica para Flaga na rua02.mp4');
                    ...
                    // Sequência de tentativas de carregamento
                    setTimeout(() => {
                      videoEl.load();
                      
                      // Aguarda um pouco e tenta reproduzir se for o vídeo atual
                      setTimeout(() => {
                        if (index === currentVideoIndex && isPlaying && videoEl.readyState >= 2) {
                          videoEl.play().catch((playError) => {
                            console.log('Falha na reprodução automática:', playError);
                    ...
                    // Tratamento padrão para outros vídeos
                    setTimeout(() => {
                      videoEl.load();
                    }, 1000);
                  }
            ...
            <div className="absolute bottom-4 left-4 right-20 text-white">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <span className="text-sm opacity-75">• {video.displayName}</span>
              </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 p-4">
        <div className="flex justify-center space-x-16">
          ...
          >
            ...
            <span className="text-white text-xs">Início</span>
          </button>
          
          <button className="flex flex-col items-center space-y-1">
            <Bell className="w-6 h-6 text-white" />
            <span className="text-white text-xs">Notificações</span>
          </button>
